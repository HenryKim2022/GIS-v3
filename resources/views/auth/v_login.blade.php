...
<html
  ...
  data-assets-path="public/materialize/assets/"
  ...
  <head>
    ...
    <!-- Core CSS -->
     <link rel="stylesheet" href="{{ asset('public/materialize/assets/vendor/css/rtl/core.css') }}" class="template-customizer-core-css" />
     <link rel="stylesheet" href="{{ asset('public/materialize/assets/vendor/css/rtl/theme-default.css') }}" class="template-customizer-theme-css" />
     <link rel="stylesheet" href="{{ asset('public/materialize/assets/css/demo.css') }}" />

    <!-- Vendors CSS -->
     <link rel="stylesheet" href="{{ asset('public/materialize/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css') }}" />
          ...
          <div class="w-px-400 mx-auto pt-5 pt-lg-0">
            ...
            <form id="formAuthentication" class="mb-3" action="index.html" method="GET">
              ...
              <div class="mb-3 d-flex justify-content-between">
                ...
                <a href="{{ base_url('forgot') }}" class="float-end mb-1" target="_self">
            ...
            <p class="text-center mt-2">
              ...
              <a href="{{ base_url('register') }}" target="_self">
